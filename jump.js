...
let Jump = class {
    constructor(gl, lane,dist) {
        ...
        this.picture = './textures/jump.jpg';
        ...
        this.ankle = new Cube(gl,[this.position[0]-this.dimension[0]/4,this.position[1],this.position[2]+this.dimension[2]/4],[this.dimension[0]/2,this.dimension[1],this.dimension[2]/2], this.picture);
    }
